...
public class PlayChess {
	...
	public static void main(String[] args) {
		...
		while (!line.equals("quit")) {
			...
			// Debugging: Print additional information after executing a move
			System.out.println("\nExecuted Move: " + line);
			if (res.message != null) {
				System.out.println("Result Message: " + res.message);
			} else {
				System.out.println("No specific message (move might be legal)");
			}
			...
			//printPiecesOnBoard(res.piecesOnBoard, board);
			System.out.println();
